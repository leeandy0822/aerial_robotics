...
if("TRUE" STREQUAL "TRUE")
  set(hw6_SOURCE_PREFIX /home/leeandy/aerial_robotics/src/hw6)
  set(hw6_DEVEL_PREFIX /home/leeandy/aerial_robotics/devel)
  set(hw6_INSTALL_PREFIX "")
  set(hw6_PREFIX ${hw6_DEVEL_PREFIX})
else()
  set(hw6_SOURCE_PREFIX "")
  set(hw6_DEVEL_PREFIX "")
  set(hw6_INSTALL_PREFIX /home/leeandy/aerial_robotics/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'hw6' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'hw6' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/leeandy/aerial_robotics/src/hw6/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT hw6_NUM_DUMMY_TARGETS)
      set(hw6_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::hw6::wrapped-linker-option${hw6_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR hw6_NUM_DUMMY_TARGETS "${hw6_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::hw6::wrapped-linker-option${hw6_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND hw6_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${hw6_dep}_FOUND)
      find_package(${hw6_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${hw6_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
