...
if("TRUE" STREQUAL "TRUE")
  set(homework_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/homework)
  set(homework_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  set(homework_INSTALL_PREFIX "")
  set(homework_PREFIX ${homework_DEVEL_PREFIX})
else()
  set(homework_SOURCE_PREFIX "")
  set(homework_DEVEL_PREFIX "")
  set(homework_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'homework' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/homework/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT homework_NUM_DUMMY_TARGETS)
      set(homework_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::homework::wrapped-linker-option${homework_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR homework_NUM_DUMMY_TARGETS "${homework_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::homework::wrapped-linker-option${homework_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND homework_LIBRARIES "${interface_target_name}")
